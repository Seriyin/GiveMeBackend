...
func NewFirestoreDB(client *firestore.Client) (datastore.FirestoreDatabase, error) {
...
func (db *firestoreDB) GetProfile(userId string) (*datastore.Profile, error) {
	ctx := context.Background()
...
func (db *firestoreDB) ListFilesSharedBy(userId string) (*datastore.Files, error) {
